    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-0.5">
                  Anda telah berhasil masuk ke ruang kerja Anda
                </p>
              </div>
            </div>
            {principalId && (
          ...
          <div className="bg-white rounded-2xl shadow-soft border border-slate-100 p-8">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              Fitur dashboard client sedang dalam pengembangan. Tim Asistenku
              akan segera melengkapi fitur-fitur yang dibutuhkan untuk mendukung
              operasional Anda.
            </p>
          </div>
        </div>
      ...
      <footer className="bg-slate-900 text-slate-400 py-8 mt-auto">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-xs">
            &copy; {new Date().getFullYear()} Asistenku. Dashboard Client
            &mdash; Area Terbatas.
          </p>
        </div>
      </footer>
